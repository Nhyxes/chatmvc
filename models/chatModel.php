...
class chatModel extends Model
{
	...
	public function insertMessage(int $userId, int $roomId, string $message): string
	{
		...
		$stmt = $this->_connection->prepare("INSERT INTO messages (user_id ,room_id ,msg_text) VALUES (:user_id ,:room_id ,:msg_text");
		$stmt->execute(array(':user_id' => $userId, ':room_id' => $roomId, ':msg_text' => $message));
